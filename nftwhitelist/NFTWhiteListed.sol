...
// @author this implementation requires a token seeker to get white-listed and then mint their own

import './MintingWhiteList.sol';

contract NFTWhiteListed is MintingWhiteList {
    ...
    function mint(address to, string memory _tokenURI) public mustBeOnMintingWhitelist {
